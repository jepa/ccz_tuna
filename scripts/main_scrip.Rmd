...
for(s in 1:length(spp)){
  ...
  for(r in 1:2){
    ...
    name_save <- paste0("~/Data/ccz_tuna/results/figs/relative_change_all_esm/",sp,"_rcp",rcp,"_pixel_chg_2050.png")
    ...
    name_save <- paste0("~/Data/ccz_tuna/results/figs/relative_change_all_esm/",sp,"_rcp",rcp,"_ccz_chg_2050.png")
